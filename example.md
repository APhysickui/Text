...
<div class="mt-8 grid grid-cols-2 gap-12">
  <div class="bg-white dark:bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700">
    <div class="text-center">
      <div class="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
        <div class="text-lg text-white font-bold">🔒</div>
      </div>
      <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">什么是SSH？</h3>
      <div class="space-y-3 text-left text-lg">
        <div class="flex items-center">
          <div class="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">网络协议</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">加密通信</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">远程控制</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">文件传输</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700">
    <div class="text-center">
      <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
        <div class="text-lg text-white font-bold">💻</div>
      </div>
      <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">常用场景</h3>
      <div class="space-y-3 text-left text-lg">
        <div class="flex items-center">
          <div class="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">服务器管理</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">代码部署</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">文件上传下载</span>
        </div>
        <div class="flex items-center">
          <div class="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
          <span class="text-gray-600 dark:text-gray-300">端口隧道</span>
        </div>
      </div>
    </div>
  </div>
...
<div class="mt-8">
  <div class="bg-gray-900 dark:bg-gray-800 rounded-2xl p-6 font-mono text-green-400">
    <div class="text-lg mb-2"># 基本连接语法</div>
    <div class="text-xl text-white">ssh username@hostname</div>
    <div class="text-lg mt-4 mb-2"># 指定端口连接</div>
    <div class="text-xl text-white">ssh -p 2222 username@hostname</div>
    <div class="text-lg mt-4 mb-2"># 使用密钥连接</div>
    <div class="text-xl text-white">ssh -i ~/.ssh/id_rsa username@hostname</div>
  </div>
</div>
    ...
    <div class="flex items-center">
      ...
      <div class="flex-1">
        ...
        <div class="bg-green-50 dark:bg-green-900/30 p-6 rounded-2xl">
          ...
          <div class="text-lg text-gray-600 dark:text-gray-300">浏览器分析URL的各个组成部分</div>
        </div>
      </div>
    </div>
  </div>
...
#### 指在服务器上运行的应用程序（如 Web 服务器、数据库服务、FTP 服务等）
...
#### 每个端口对应一个唯一的服务或进程（在同一个 IP 和协议下）

---

# 以 本 Slides 为例 (借助 1panel)

# 让别人访问你的网页信息的大概流程

## 准备：

### 1. 拥有一台自己的云服务器(这里以 Clab 为例)

### 2. 拥有一个域名(若服务器在大陆则需要完成 ICP 备案)
...
# 肆 -- 安装 Nginx 并配置反向代理 (这里以 1panel 示例)
...
### 在域名注册商处申请 ssl 证书，（一般用 3 个月时长免费的证书就可以）
...
### 为了减轻运维的负担，依然采用 1panel 面板部署 ssl 证书

### 实际上 ssl 证书 也是配置在 Nginx 的配置文件里的
